...
//    public static String branch = "branch";
    ...
    public static String processDefinitionId = "processDefinitionId";
    public static String pageNo = "pageNo";
    public static String pageSize = "pageSize";
    public static String totalList = "totalList";
    ...
    public static String startNodeList = "startNodeList";
    ...
    public static String deleteRelationUrl = "/dolphinscheduler/projects/{projectCode}/process-task-relation/{taskCode}";
    ...
    public static String queryScheduleListPagingUrl = "/dolphinscheduler/projects/{projectCode}/schedules";
    public static String updateBasicInfoPagingUrl = "/dolphinscheduler/projects/{projectCode}/process-definition/{code}/basic-info";
    public static String startProcessInstanceUrl = "/dolphinscheduler/projects/{projectCode}/executors/start-process-instance";

    public static boolean sharedData = true;
