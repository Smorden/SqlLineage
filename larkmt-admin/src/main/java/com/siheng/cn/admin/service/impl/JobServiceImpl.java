...
import com.siheng.cn.admin.dto.FlinkXBatchJsonBuildDto;
import com.siheng.cn.admin.dto.FlinkXJsonBuildDto;
import com.siheng.cn.admin.entity.JobTemplate;
import com.siheng.cn.admin.mapper.JobGroupMapper;
import com.siheng.cn.admin.mapper.JobInfoMapper;
import com.siheng.cn.admin.mapper.JobLogGlueMapper;
import com.siheng.cn.admin.mapper.JobLogMapper;
import com.siheng.cn.admin.mapper.JobLogReportMapper;
import com.siheng.cn.admin.mapper.JobTemplateMapper;
import com.siheng.cn.admin.service.DatasourceQueryService;
import com.siheng.cn.admin.service.FlinkxJsonService;
import com.siheng.cn.admin.service.JobService;
import com.siheng.cn.admin.core.cron.CronExpression;
import com.siheng.cn.admin.core.route.ExecutorRouteStrategyEnum;
import com.siheng.cn.admin.core.thread.JobScheduleHelper;
import com.siheng.cn.admin.core.util.I18nUtil;
import com.siheng.cn.admin.entity.JobGroup;
import com.siheng.cn.admin.entity.JobInfo;
import com.siheng.cn.admin.entity.JobLogReport;
import com.siheng.cn.admin.util.DateFormatUtils;
import com.siheng.core.biz.model.ReturnT;
import com.siheng.core.enums.ExecutorBlockStrategyEnum;
import com.siheng.core.glue.GlueTypeEnum;
import com.siheng.core.util.DateUtil;
